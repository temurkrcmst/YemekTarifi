<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/YemekTarifi.Master" CodeBehind="KategoriDetay.aspx.cs" Inherits="YemekTarifi.KategoriDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style1">
            <tr>
                <td style="background-color: #FFCC99"><a href="YemekDetay.aspx?Yemekid=<%#Eval("Yemekid") %>">
